    ...
    return (
        <>
            <Typography variant='h3' component='h2' className={classes.Title}>
                Stawka żywieniowa 15 zł/dzień w tym 4 posiłki:
            </Typography>
            <ul>
                <li>
                    <Typography variant='body1'>Śniadanie 2,00zł</Typography>
                </li>
                <li>
                    <Typography variant='body1'>2-gie Śniadanie 1,50 zł</Typography>
                </li>
                <li>
                    <Typography variant='body1'>Obiad (Zupa + Drugie danie) 9,50 zł</Typography>
                </li>
                <li>
