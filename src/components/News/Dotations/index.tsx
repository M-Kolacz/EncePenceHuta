import { NewsTemplate, NewsParagraph, NewsImage } from '../NewsTemplate';
...
export const Dotations: React.FC<DotationsProps> = () => {
    return (
        <NewsTemplate title='Dotacje Gminy Miejskiej Kraków do opieki nad dziećmi w wieku do lat 3 w 2021 roku'>
            ...
            <NewsParagraph>
                W roku 2021 od 1 stycznia 2021 roku Gmina Miejska Kraków udzielać będzie dotacji (dofinansowania) do
                dzieci objętych opieką. Podstawowa kwota dotacji (dofinansowania) udzielanej przez Gminę Miejską Kraków
                wynosi 1,70zł za godzinę opieki nad dzieckiem. Zgodnie z podpisaną z Gminą Miejską Kraków umową, w
                ...
                opiekunami prawnymi umowy) x 1,70zł.
            </NewsParagraph>
            <NewsParagraph>
                W przypadku objęcia opieką dziecka z orzeczeniem o niepełnosprawności Gmina Miejska Kraków udzielać
                będzie podmiotowi świadczącemu opiekę dodatkowej dotacji (dofinansowania) w wysokości 2,40zł za każdą
