...
export const Dotations: React.FC<DotationsProps> = () => {
    return (
        <NewsTemplate title='Dotacje Gminy Miejskiej Kraków do opieki nad dziećmi w wieku do lat 3 w 2025 roku'>
            <NewsImage src='images/jpg/logoKrakow.jpg' alt='Logo miasta Kraków' />
            <NewsParagraph>
                W roku 2025 od 1 stycznia 2025 roku Gmina Miejska Kraków udzielać będzie dotacji (dofinansowania) do
